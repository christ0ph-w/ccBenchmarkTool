...
class ProcessTreeGraph(nx.MultiDiGraph):
    ...
    def _build_process_tree_subgraph(self, tree: ProcessTree, start_node: Hashable, end_node: Hashable, iac: int = 1) -> None:
        match tree.operator:
            case None:
    ...
    def _build_process_tree_subgraph_leaf(self, tree: ProcessTree, start_node: Hashable, end_node: Hashable, iac: int = 1) -> None:
        if not is_leaf(tree):
    ...
    def _build_process_tree_subgraph_sequence(self, tree: ProcessTree, start_node: Hashable, end_node: Hashable, iac: int = 1) -> None:
    ...
    def _build_process_tree_subgraph_xor(self, tree: ProcessTree, start_node: Hashable, end_node: Hashable, iac: int = 1) -> None:
    ...
    def _build_process_tree_subgraph_parallel(self, tree: ProcessTree, start_node: Hashable, end_node: Hashable, iac: int = 1) -> None:
    ...
    def _build_process_tree_subgraph_loop(self, tree: ProcessTree, start_node: Hashable, end_node: Hashable, iac: int = 1) -> None:
