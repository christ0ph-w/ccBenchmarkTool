...
export function BenchmarkHeader({ algorithms, status, currentAlgorithm, progress, onStart, onBack, isFileMode }: BenchmarkHeaderProps) {
    ...
    <div className="flex items-center justify-between sticky top-0 bg-background z-10 pb-4 border-b">
      <div>
        <h1 className="text-2xl font-bold">
          {isFileMode ? 'Saved Results' : 'Benchmark Results'}
        </h1>
